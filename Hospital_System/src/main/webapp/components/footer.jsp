    ...
    <div class="container p-3">
        ...
        <div class="row my-4">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <p class="text-center">Homless animal shelter The budgetary unit of the Capital City
                    of Warsaw</p>
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="#!" class="text-white"><i class="fas fa-paw pe-3"></i>When your pet
                            is missing</a>
                    </li>
                    <li class="mb-2">
                    ...
                    <li class="mb-2">
                        <a href="#!" class="text-white"><i class="fas fa-paw pe-3"></i>How to
                            adopt?</a>
                    </li>
                    <li class="mb-2">
