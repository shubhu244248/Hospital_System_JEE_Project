...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i
			class="fa-regular fa-hospital"></i> Sarwadhya Hospital System</a>
				...
				<c:if test="${empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="doctor_login.jsp"><i
							class="fas fa-sign-in-alt"></i> DOCTOR</a></li>
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="user_appointment.jsp"><i
							class="fas fa-sign-in-alt"></i> APPOINTMENT</a></li>
					<li class="nav-item"><a class="nav-link active"
				...
				<c:if test="${not empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="view_appointment.jsp"><i
							class="fas fa-sign-in-alt"></i> VIEW
							APPOINTMENT</a></li>
